import{u,R as c,j as e,L as h}from"./index-C_Q-b9_Z.js";import{b as y}from"./banner-DoJb6kMf.js";import{s as b}from"./Silk-BXyBIzFR.js";function _(){const r=u(),[s,l]=c.useState({x:0,y:0});return c.useEffect(()=>{const t=o=>{o.key==="1"&&r("/manual/app"),o.key==="2"&&r("/manual/web")};return window.addEventListener("keydown",t),()=>window.removeEventListener("keydown",t)},[r]),e.jsxs("div",{className:"min-h-screen relative overflow-hidden",onMouseMove:t=>l({x:t.clientX,y:t.clientY}),style:{"--mx":`${s.x}px`,"--my":`${s.y}px`,filter:"saturate(1.08) contrast(1.08) brightness(1.03)"},children:[e.jsx("img",{src:y,className:"absolute inset-0 w-full h-full object-cover opacity-10",alt:""}),e.jsx("div",{className:"pointer-events-none absolute inset-0 bg-[radial-gradient(400px_400px_at_var(--mx)_var(--my),rgba(255,255,255,0.12),transparent_30%)]"}),e.jsx("div",{className:"pointer-events-none absolute inset-0 opacity-5",style:{backgroundImage:"radial-gradient(rgba(255,255,255,0.06) 1px, transparent 1px)",backgroundSize:"3px 3px"}}),e.jsx("img",{src:b,className:"absolute -right-24 -bottom-40 w-[50rem] opacity-50 pointer-events-none animate-slow-float",alt:""}),e.jsx("section",{className:"relative min-h-dvh flex items-center",children:e.jsxs("div",{className:"relative z-10 max-w-5xl mx-auto px-6 py-16",children:[e.jsx("h1",{className:`text-left ml-0 mr-auto font-extrabold tracking-tight leading-none\r
